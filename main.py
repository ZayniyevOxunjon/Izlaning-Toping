...
API_TOKEN = '7179871308:AAFb4FY5lYWVR3g3oCZZhrjkwfd7oov4gis'
...
async def start_bot(bot: Bot):
    await bot.send_message(6567499972,"Bot ishga tushdi !! ")

async def shutdown_bot(bot: Bot):
    await bot.send_message(6567499972,"Bot o'chdi !! ")
